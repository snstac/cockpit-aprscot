...
export const Application: React.FC = () => {
    ...
    const handleEnvVarFormSubmit = useCallback(
        async (e: React.FormEvent) => {
            ...
            const newConfig = serializeEnvDefault(fileLines, envVarForm, CONF_PARAMS, '# Added by Cockpit APRSCOT');
            setSaveBusy(true);
            try {
                await cockpit
    ...
    return (
        <div data-testid="aprscot-app">
            ...
            <TlsUploadCard
                tlsDir="/etc/aprscot/tls"
                keyUser="aprscot"
                testIdPrefix="aprscot"
                onToast={setToast}
                onInstalledPaths={onTlsInstalled}
            />

            <Card
                className="aprscot-expandable-card"
                isExpanded={isConfigExpanded}
                data-testid="aprscot-config-card"
            >
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsConfigExpanded(!isConfigExpanded)}
                    toggleButtonProps={{
                        id: 'aprscot-config-expand',
                ...
                <CardExpandableContent>
                    ...
                    <form onSubmit={handleEnvVarFormSubmit}>
                        <div className="aprscot-config-form-layout" data-testid="aprscot-config-form-layout">
                            <div className="aprscot-config-body-scroll" data-testid="aprscot-config-scroll">
                            ...
                            <div className="aprscot-config-actions">
                                <Checkbox
                                id="aprscot-save-restart"
                                label={_('Restart aprscot after save')}
            ...
            <Card className="aprscot-expandable-card" isExpanded={isDebugExpanded}>
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsDebugExpanded(!isDebugExpanded)}
                    toggleButtonProps={{
                        id: 'aprscot-debug-expand',
            ...
            <Card className="aprscot-expandable-card" isExpanded={isAdvancedExpanded}>
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsAdvancedExpanded(!isAdvancedExpanded)}
                    toggleButtonProps={{
                        id: 'aprscot-advanced-expand',
