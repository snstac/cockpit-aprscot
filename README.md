# cockpit-aprscot — AIS vessel tracking for TAK, in your browser

A [Cockpit](https://cockpit-project.org/) web console plugin for
[APRSCOT](https://github.com/snstac/aprscot), the **APRS to TAK gateway**. Track
...
control, `/etc/default/aprscot` configuration, TAK TLS certificates, and live status —
no SSH required.
...
| Ships & vessels via AIS | [aprscot](https://github.com/snstac/aprscot) | [cockpit-aprscot](https://github.com/snstac/cockpit-aprscot), [cockpit-aiscatcher](https://github.com/snstac/cockpit-aiscatcher) |
